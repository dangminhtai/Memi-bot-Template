        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1">
            ...
            <p className="text-slate-400">
              Bot Discord đa năng được thiết kế để nâng cao trải nghiệm máy chủ của bạn.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#testimonials" className="text-slate-400 hover:text-violet-400 transition-colors">Đánh giá</a></li>
            </ul>
          </div>
          <div>
            <h4 className="text-lg font-semibold text-white mb-4">Cộng đồng</h4>
            <ul className="space-y-2">
              <li><a href="https://discord.gg/yksE5pNDtk" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-violet-400 transition-colors">Server Hỗ Trợ</a></li>
              <li><a href="#" className="text-slate-400 hover:text-violet-400 transition-colors">Ủng hộ (Ko-fi)</a></li>
            </ul>
          </div>
          <div>
